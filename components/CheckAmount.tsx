...
import transfer_reward from "../stacks_callFunction/transfer_reward";
...
const CheckAmount: React.FC<CheckAmountProps> = ({
  ...
  const rider=userSession.loadUserData().profile.stxAddress.testnet;
        ...
        <div className="flex-1 flex flex-row justify-center items-center m-10">
          <div className="flex flex-col items-center">
            ...
            <form className="flex flex-col gap-4">
              ...
              <button
                type="button"
                onClick={()=>transfer_reward(sendToWallet,tipAmount,address,rider)}
